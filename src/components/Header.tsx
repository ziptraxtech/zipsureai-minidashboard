      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            <a href="#dashboard" className="text-white/90 hover:text-white transition-colors duration-200 font-medium">
              Dashboard
            </a>
            <a href="#analytics" className="text-white/90 hover:text-white transition-colors duration-200 font-medium">
              Analytics
            </a>
            <a href="#reports" className="text-white/90 hover:text-white transition-colors duration-200 font-medium">
              Reports
            </a>
